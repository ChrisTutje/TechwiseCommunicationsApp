...
// Array of alien image sources
const alienImageSources = [
    "./alien.png",
    "./alien-yellow.png",
    "./alien-cyan.png",
    "./alien-magenta.png",
...
function createAliens() {
    for (let c = 0; c < alienColumns; c++) {
        for (let r = 0; r < alienRows; r++) {
            ...
            const randomIndex = Math.floor(Math.random() * alienImageSources.length);
            const randomImageSource = alienImageSources[randomIndex];

            // Create an alien with the selected image source
            let alien = {
                img: new Image(),
            ...
            alien.img.src = randomImageSource;

            // Push the alien to the array
